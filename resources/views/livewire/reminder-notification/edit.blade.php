<x:component::page.form title="Erinnerung bearbeiten">
    <x-slot:actions>
        <x:component::button.secondary wire:click="cancel">Abbrechen</x:component::button.secondary>
        <x:component::button.secondary wire:click="updateAndNew">Speichern & Neu</x:component::button.secondary>
        <x:component::button.primary wire:click="updateAndIndex">Speichern</x:component::button.primary>
    </x-slot:actions>
